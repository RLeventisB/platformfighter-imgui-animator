...
namespace Rune.MonoGame
{
	...
	{
		public const float EpsilonBig = 0.001f;
		public const float EpsilonSmall = 0.000001f;
			...
			ref Vector3 worldPosition)
		{
			...
			float distanceToPlane = Vector3.Dot(normal, position) - distance;
		...
		{
			float x = (float)Math.Floor(vector.X * dimension) / dimension;
			float y = (float)Math.Floor(vector.Y * dimension) / dimension;
			float z = (float)Math.Floor(vector.Z * dimension) / dimension;
		...
		{
			float x = (float)Math.Round(vector.X * dimension) / dimension;
			float y = (float)Math.Round(vector.Y * dimension) / dimension;
			float z = (float)Math.Round(vector.Z * dimension) / dimension;
		...
		{
			float x = (float)Math.Ceiling(vector.X * dimension) / dimension;
			float y = (float)Math.Ceiling(vector.Y * dimension) / dimension;
			float z = (float)Math.Ceiling(vector.Z * dimension) / dimension;
